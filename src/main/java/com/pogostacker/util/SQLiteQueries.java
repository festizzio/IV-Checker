...
public final class SQLiteQueries {
    ...
    public static final String CONNECTION_STRING =
            "jdbc:sqlite:C:/Users/festi/IdeaProjects/IV Checker/src/main/resources/" + DB_NAME;
    ...
    public static final String SELECT_POKEMON = "SELECT * FROM " + TABLE_POKEMON + " WHERE " + COLUMN_POKEMON_NAME + " = ?";
